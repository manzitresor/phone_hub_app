...
<section class="container px-4 mx-auto ml-[200px]">
    <div class="flex items-center gap-x-3">
        ...
        <span class="px-3 py-1 text-xs text-blue-600 bg-blue-100 rounded-full dark:bg-gray-800 dark:text-blue-400">2 users</span>
    </div>
                                ...
                                <td class="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                    <div class="inline-flex items-center gap-x-3">
                                        ...
                                        <div class="flex items-center gap-x-2">
                                            ...
                                            <div>
                                                <h2 class="font-medium text-gray-800 dark:text-white ">Ema Watson</h2>
                                                <p class="text-sm font-normal text-gray-600 dark:text-gray-400">@EmaWatson</p>
                                            </div>
                                        </div>
                                    </div>
                                </td>
